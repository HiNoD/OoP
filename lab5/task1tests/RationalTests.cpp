...
/*
	Рациональное число: равно нулю по умолчанию (0/1), может быть созданно из целого в формате (n / 1),
	может быть задано с указанием числителя и знаменателя, хранится в нормализованном виде
*/
